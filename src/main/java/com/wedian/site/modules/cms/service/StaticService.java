 ...
 * 
 */
package com.wedian.site.modules.cms.service;
...
import com.wedian.site.modules.cms.dao.ArticleDao;
...
public class StaticService implements ServletContextAware {
	...
	public int build(String templatePath, String staticPath, Map<String, Object> model) {
		...
		Writer writer = null;
		try {
			freemarker.template.Template template = null; //freeMarkerConfigurer.getConfiguration().getTemplate(templatePath);
...
//	@Transactional(readOnly = true)
//	public int build(ArticleData article) {
...
//	}
	...
	public int delete(Article article) {
		...
		int deleteCount = 0;
//		for (int pageNumber = 1; pageNumber <= article.getgetTotalPages() + 1000; pageNumber++) {
//			article.setPageNumber(pageNumber);
