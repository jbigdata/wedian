 ...
 */
package com.wedian.site.modules.act.service.ext;

import java.util.List;
import java.util.Map;

import com.wedian.site.common.utils.SpringContextHolder;
import com.wedian.site.modules.act.utils.ActUtils;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.wedian.site.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.wedian.site.modules.sys.entity.User(null, userId)))){
